...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            setup_app_component_1.SetupAppComponent,
            setup_app_edit_component_1.SetupAppEditComponent,
            setup_app_add_component_1.SetupAppAddComponent,
            setup_app_detail_component_1.SetupAppDetailComponent,
            setup_app_overview_component_1.SetupAppOverviewComponent,
            setup_app_projects_component_1.SetupAppProjectsComponent
        ],
        providers: [employee_service_1.EmployeeService, login_service_1.LoginService, check_login_guard_1.CheckLoginGuard, check_save_form_guard_1.CheckSaveFormGuard, setup_app_service_1.SetupAppService],
